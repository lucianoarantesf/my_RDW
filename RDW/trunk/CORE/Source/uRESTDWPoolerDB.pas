...

{
 ...
 de produtividade e flexibilidade para produção de Serviços REST/JSON/BINARY, simplificando o processo para você programador.
...
uses SysUtils,  Classes,
     ...
     {$ELSE}
       ...
       {$IF CompilerVersion > 25} // Delphi XE7 pra cima
          , FireDAC.Comp.Client
          {$IF Defined(HAS_FMX)}  // Incluído inicialmente para iOS/Brito
