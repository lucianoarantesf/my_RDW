...
var
  ...
  LibHandle: {$ifdef FPC}{$ifdef FPC_NEWRTTI}TLibHandle{$else}THandle{$endif}{$else}HMODULE{$endif};
  Libwship6Handle: {$ifdef FPC}{$ifdef FPC_NEWRTTI}TLibHandle{$else}THandle{$endif}{$else}HMODULE{$endif};
  LibSecurHandle: {$ifdef FPC}{$ifdef FPC_NEWRTTI}TLibHandle{$else}THandle{$endif}{$else}HMODULE{$endif};
